#!/usr/bin/env python3
"""
Fix XLK split application - correctly apply 2-for-1 split only before December 5, 2025
"""

import pandas as pd
from pathlib import Path

def fix_xlk_split_application(file_path, split_date, split_ratio):
    ...
    # For data after split date, ensure original strikes are preserved
...
def main():
    ...
    print("🔄 Fixing XLK split application - only apply before December 5, 2025...")
    ...
    for year in years:
        ...
        for freq in frequencies:
            ...
            if file_path.exists():
                rows_processed = fix_xlk_split_application(file_path, split_date, split_ratio)
