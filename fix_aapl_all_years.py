#!/usr/bin/env python3
"""
Fix AAPL data for all years to include all historical columns.
"""
...
def fix_aapl_data_all_years(file_path):
    """Fix AAPL data to include all historical columns."""
...
def main():
    ...
    years_to_fix = [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025]
    ...
    for year in years_to_fix:
        ...
        for file_path in files_to_process:
            if os.path.exists(file_path):
                fix_aapl_data_all_years(file_path)
            else:
                print(f"⚠️ File not found: {file_path}")
    
    print("\n✅ AAPL data fixed for all years!")
