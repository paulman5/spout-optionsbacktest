#!/usr/bin/env python3
"""
Revert AMZN data and apply 20-for-1 split only before June 6, 2022
"""

import pandas as pd
from pathlib import Path

def revert_and_apply_amzn_split(file_path, split_date, split_ratio):
...
def main():
    """Main function to revert and apply AMZN split"""
    print("🔄 Reverting AMZN data and applying 20-for-1 split only before June 6, 2022...")
    ...
    for year in years:
        ...
        for freq in frequencies:
            ...
            if file_path.exists():
                rows_processed = revert_and_apply_amzn_split(file_path, split_date, split_ratio)
                total_rows_processed += rows_processed
            else:
                print(f"   File not found: {file_path}")
    
    print(f"\n✅ AMZN data reverted and split applied!")
