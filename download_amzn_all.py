...
def download_amzn_all_years():
    """Download AMZN data for all years 2016-2025"""
    
    years = [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025]
    
    print("🚀 Downloading AMZN data for years 2016-2025")
    print("=" * 60)
    ...
    print(f"\n{'='*60}")
    print("✅ AMZN download completed for all years 2016-2025")
