#!/usr/bin/env python3
"""
Divide ONLY XLK strike prices BEFORE December 5, 2025 by 2
"""

import pandas as pd
from pathlib import Path

def divide_xlk_strikes_only_before(file_path, split_date, split_ratio):
...
def main():
    """Main function to divide XLK strike prices only before December 5, 2025"""
    print("🔄 Dividing ONLY XLK strike prices BEFORE December 5, 2025 by 2...")
    ...
    for year in years:
        ...
        for freq in frequencies:
            ...
            if file_path.exists():
                rows_processed = divide_xlk_strikes_only_before(file_path, split_date, split_ratio)
                total_rows_processed += rows_processed
            else:
                print(f"   File not found: {file_path}")
    
    print(f"\n✅ XLK strike prices divided by 2 (only before Dec 5, 2025)!")
