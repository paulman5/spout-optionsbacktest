...
Correct formula: (strike / underlying_spot) * 100
"""
...
def main():
    ...
    print("=" * 70)
    print("📋 Correct Formula: (strike / underlying_spot) * 100")
    print("   - strike: in dollars (split-adjusted)")
    print("   - underlying_spot: in dollars (split-adjusted)")
    print("   - Result: OTM percentage (positive = OTM, negative = ITM)")
    print("   - ITM: YES if strike < underlying_spot, NO otherwise")
    print("=" * 70)
