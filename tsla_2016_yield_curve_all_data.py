#!/usr/bin/env python3
"""
TSLA 2016 Yield Curve Analysis - ALL Data Points
...
def prepare_yield_data(df):
    ...
    # Filter for valid data but KEEP ALL OTM ranges
    df_clean = df[
...
def create_yield_curve_plot(df_clean):
    """Create yield curve plot with ALL individual points and trend line"""
    ...
    if len(non_exercised) > 0:
        ax.scatter(non_exercised['otm_pct'], non_exercised['apy'], 
                 alpha=0.6, s=12, c='green', edgecolors='darkgreen', 
    ...
    if len(exercised) > 0:
        ax.scatter(exercised['otm_pct'], exercised['apy'], 
                 alpha=0.8, s=15, c='red', edgecolors='darkred', 
    ...
    ax.set_title('TSLA 2016 Options Yield Curve: ALL Contract Analysis (OTM 0-40%, APY 0-12.5%)', 
    ...
    # Save plot
    output_path = "/Users/paulvanmierlo/spout-optionsbacktest/tsla_2016_yield_curve_all_data.png"
...
def main():
    ...
    print("📊 Creating ALL data points plot: OTM (0-40%) vs APY (0-12.5%)")
