#!/usr/bin/env python3
"""
Fix XLE strike prices: divide by 2 for all dates before 2025-12-05
(XLE had a 2-for-1 stock split on December 5, 2025)
"""
...
print("=" * 80)
print("FIXING XLE STRIKE PRICES FOR PRE-SPLIT DATES")
print("=" * 80)
