#!/usr/bin/env python3
"""
Apply 2-for-1 stock split to XLK options before December 5, 2025, with 2 decimal places
"""

import pandas as pd
from pathlib import Path

def apply_xlk_split_before_date(file_path, split_date, split_ratio):
    """Apply stock split to XLK options before specified date"""
...
def main():
    """Main function to apply XLK split with 2 decimal places"""
    print("🔄 Applying 2-for-1 stock split to XLK options before December 5, 2025, with 2 decimal places...")
    ...
    for year in years:
        ...
        for freq in frequencies:
            ...
            if file_path.exists():
                rows_processed = apply_xlk_split_before_date(file_path, split_date, split_ratio)
                total_rows_processed += rows_processed
            else:
                print(f"   File not found: {file_path}")
    
    print(f"\n✅ XLK split with 2 decimal places applied!")
