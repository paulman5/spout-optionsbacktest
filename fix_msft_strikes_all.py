#!/usr/bin/env python3
"""
Reset all MSFT strike prices: extract from ticker and divide by 1000
"""
...
def extract_strike_from_ticker(ticker):
    """Extract strike from ticker format: O:MSFT180126C00197500"""
...
data_dir = Path('python-boilerplate/data/MSFT/holidays')
files = sorted(data_dir.glob('*_options_pessimistic.csv'))

print("=" * 80)
print("RESETTING MSFT STRIKE PRICES FOR ALL HOLIDAY FILES")
print("=" * 80)
