#!/usr/bin/env python3
"""
Apply 20-for-1 stock split to GOOG data before July 18, 2022.
"""
...
def apply_goog_stock_split(file_path):
    """Apply 20-for-1 stock split to data before July 18, 2022."""
    ...
    # Apply 20-for-1 split to data before July 18, 2022
    ...
    print(f"  ✅ Applied 20-for-1 stock split to {len(df[mask])} rows before July 18, 2022")

def main():
    """Apply 20-for-1 stock split to GOOG data for all years."""
    ...
    for year in years:
        ...
        for file_path in files_to_process:
            if os.path.exists(file_path):
                apply_goog_stock_split(file_path)
            else:
                print(f"⚠️ File not found: {file_path}")
    
    print("\n✅ 20-for-1 stock split applied to GOOG data!")
