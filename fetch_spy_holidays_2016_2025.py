#!/usr/bin/env python3
"""
Fetch SPY weekly options with holiday adjustments for 2016-2025:
...
for TEST_YEAR in YEARS:
        # Check if output file already exists - skip 2016-2021, but process 2022-2025
        output_base_dir = base_path / "data" / TICKER / "holidays"
        output_file = output_base_dir / f"{TEST_YEAR}_options_pessimistic.csv"
        if output_file.exists() and TEST_YEAR < 2022:
            print(f"\n{'='*80}")
