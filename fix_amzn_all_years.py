#!/usr/bin/env python3
"""
Fix AMZN data for all years 2016-2021, 2019-2021 to include all historical columns.
"""
...
def fix_amzn_data_all_years(file_path):
    """Fix AMZN data to include all historical columns."""
...
def main():
    """Fix AMZN data for all years to include all historical columns."""
    amzn_dir = "/Users/paulvanmierlo/spout-optionsbacktest/python-boilerplate/data/AMZN"
    years_to_fix = [2016, 2017, 2019, 2020, 2021]
    ...
    for year in years_to_fix:
        ...
        for file_path in files_to_process:
            if os.path.exists(file_path):
                fix_amzn_data_all_years(file_path)
            else:
                print(f"⚠️ File not found: {file_path}")
    
    print("\n✅ AMZN data fixed for all years 2016-2021, 2019-2021!")
